    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-100 via-blue-50 to-red-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-blue-800 mb-4">СПРАВКИ</h1>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-700">
              ...
              <p className="text-gray-600">
                Документы, подтверждающие прохождение военной службы
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-red-600">
              ...
              <p className="text-gray-600">
                Медицинские документы и справки о состоянии здоровья
              </p>
            </div>
          </div>
        </div>
